...
summary function gives the the coefficients with their standard error, t-value and p-value as well as the estimate of varinace and the degrees of freedom in the model.
```{r}
linreg_mod$summary()
```
